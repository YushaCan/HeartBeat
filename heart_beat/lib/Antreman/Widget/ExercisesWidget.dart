...
import 'package:heart_beat/Antreman/Data/exerciseSets.dart';
import 'package:heart_beat/Antreman/Model/exerciseSet.dart';
...
class _ExercisesWidgetState extends State<ExercisesWidget> {
  ...
  Widget buildWorkouts() => GestureDetector(
    ...
    child: Column(
  children: exerciseSets.where((element) => element.exerciseType == selectedType)
      .map((exerciseSet) => Container(
